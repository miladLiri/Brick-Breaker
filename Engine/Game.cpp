...
Game::Game(MainWindow& wnd)
	...
	skate(200),
	ball({ 300,550 }, { 3, 6 })
	//brick(Rect(10, 100, 10, 500), Colors::Blue)
{
}
...
void Game::UpdateModel()
{
	if (isGameStarted) {
		...
		if (bricks.isAllBricksDestroyed() || ball.checkBaseCollision()) {
			return;
		}
...
void Game::ComposeFrame()
{
	...
	if (ball.checkBaseCollision()) {
		drawGameover(360, 300);
	}
...
{
	gfx.DrawRect(x, y, 100, 100, Colors::Yellow);
}
